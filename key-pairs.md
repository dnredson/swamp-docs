# <a name="top"></a>Connecting to the Instance

* [Introduction](#introduction)
* [Before starting...](#before-starting)
    * [Create a key pair](#create-kp)
    * [Import a Key pair](#import-kp)
    * [Connecting on Windoes](#connect-win)
    * [Issuing commands to the broker](#issuing-commands-to-the-broker)
* [Connecting](#connecting)
    * [Linux](#connecting-linux)
    * [Windows](#connecting-windows)
    * [Mac](#connecting Mac)
    * [Update entity](#update-entity)
* [Injecting a Key to a Instance](#inject)
    * [get-windows](#getting-public-win)
    * [get-Linux/Mac](#getting-public-linux-mac)
* [Context availability management](#context-availability-management)

## Introduction

This tutorial will explain how to create, import and inject a key pair. In the sequence, you will learn how to connect to your instance :).
...
Before starting, let's prepare the Keys and check the user that we must use to connect to the Instance.

[Top](#top)

#### Example case

 In the side menu, select the option Compute > Key Pair and click on the “Create key pair” to generate a new one
![](create-kp.png "create-kp.png")
